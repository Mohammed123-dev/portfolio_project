...
const About = () => {
  ...
  const skills = [
    ...
    { name: 'DSA', icon: '🧩', color: '#3B82F6', level: 85 }
  ];

  const achievements = [

    { icon: '💼', title: 'Internships', desc: 'Larch Soft Pvt.Ltd. ' }
  ];
          ...
          >
            ...
            <div style={styles.profileSection}>
              <div style={styles.avatar} className="avatar-pulse">
                <span style={styles.avatarText}>MM</span>
            ...
            <div style={styles.infoGrid}>
              <div style={styles.infoItem} className="info-slide">
                ...
                <div>
                  ...
                  <p style={styles.infoDesc}>B.Tech CSE, JBREC Hyderabad (2026)</p>
                </div>
              </div>
