...
import { Code, Coffee, Leaf, Terminal, Database } from 'lucide-react';
    ...
    >
      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <h2
            className={`text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-gray-800 to-gray-600 dark:from-white dark:to-gray-300 bg-clip-text text-transparent transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
              }`}
          >
            Technical Skills
          </h2>
          <div
            className={`w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto rounded-full transform transition-all duration-1000 delay-300 ${isVisible ? 'scale-x-100 opacity-100' : 'scale-x-0 opacity-0'
              }`}
          ></div>
          <p
            className={`mt-4 text-gray-600 dark:text-gray-400 max-w-2xl mx-auto transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
              }`}
          >
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 md:gap-8 max-w-4xl mx-auto">
          {skills.map((skill, index) => {
            ...
            return (
              <div
                key={skill.name}
                className={`group relative transform transition-all duration-700 ease-out ${isVisible
