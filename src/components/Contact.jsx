...
const Contact = () => {
  ...
  // ==============================
  // FORMSUBMIT (sends to your Gmail)
  // ==============================
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://formsubmit.co/ajax/mdmaibu8418@gmail.com', {
        method: 'POST',
        headers: {
  ...
  const socialLinks = [
    {
      icon: faGithub,
      name: 'GitHub',
      url: 'https://github.com/Mohammed123-dev',
    },
    {
      icon: faLinkedin,
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/maibu-md-863426351/',
    },
  ];
        ...
        <div style={responsiveStyles.contentGrid}>
            ...
            >
              ...
              <div style={responsiveStyles.socialContainer}>
                {socialLinks.map((social, index) => (
                  ...
                  >
                    <FontAwesomeIcon icon={social.icon} style={responsiveStyles.socialIcon} />
                  </a>
                ))}
              </div>
            </div>
          ...
          <div style={responsiveStyles.rightSection}>
            ...
            >
              {/* SUCCESS MESSAGE */}
              {isSubmitted && (
                <div style={responsiveStyles.successMessage} className="success-popup" role="alert">
              ...
              {/* ERROR MESSAGE */}
              {submitError && (
                <div style={responsiveStyles.errorMessage} className="error-popup" role="alert">
                  <span style={responsiveStyles.errorIcon}>⚠️</span>
              ...
              <form style={responsiveStyles.form} onSubmit={handleSubmit}>
                ...
                <div style={responsiveStyles.inputGroup}>
                  <label htmlFor="name" style={responsiveStyles.label}>
                    Full Name
                  </label>
                  <input
                    type="text"
                ...
                {/* EMAIL */}
                <div style={responsiveStyles.inputGroup}>
                  <label htmlFor="email" style={responsiveStyles.label}>
                    Email Address
                  </label>
                  <input
                    type="email"
                ...
                {/* MESSAGE */}
                <div style={responsiveStyles.inputGroup}>
                  <label htmlFor="message" style={responsiveStyles.label}>
                    Your Message
                  </label>
                  <textarea
                    id="message"
                ...
                >
                  <span style={responsiveStyles.buttonText}>
                    {isSubmitting ? 'Sending...' : 'Send Message'}
                  </span>
                  <span style={responsiveStyles.buttonIcon}>
                    {isSubmitting ? '⏳' : '✨'}
                  </span>
                </button>
              </form>
